...
EVIL_CALLEE.add_to_trace(instr0)
EVIL_CALLEE.add_to_trace(instr1)
EVIL_CALLEE.add_to_trace(instr2)
EVIL_CALLEE.add_to_trace(instr3)
EVIL_CALLEE.add_to_trace(instr4)
EVIL_CALLEE.add_to_trace(instr5)
EVIL_CALLEE.add_to_trace(instr6)
EVIL_CALLEE.add_to_trace(instr7)
EVIL_CALLEE.add_to_trace(instr8)
EVIL_CALLEE.add_to_trace(instr9)
EVIL_CALLEE.add_to_trace(instr10)
